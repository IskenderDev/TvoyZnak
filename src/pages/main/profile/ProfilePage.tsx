...
export default function ProfilePage() {
      ...
      <>
        ...
        <section className="min-h-screen py-12 text-white">
          <div className="mx-auto w-full px-4 desktop:px-6">
            <h1 className="mb-6 text-3xl uppercase desktop:text-4xl">Профиль</h1>
            <div className="mx-auto max-w-xl rounded-2xl bg-white px-10 py-12 text-center text-black shadow-sm">
              <h2 className="text-2xl uppercase desktop:text-3xl">Требуется авторизация</h2>
              <p className="mt-3 text-sm text-black/70 desktop:text-base">
  ...
  const lotRows: ProfileLotRow[] = visibleLots.map((item) => ({
    ...
    plate: {
      ...
      regionId: formatRegionCode(item.plate.regionCode || item.region || ""),
    },
