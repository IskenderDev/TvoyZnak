...
export default function HomePage({ hideSeo = false }: HomePageProps = {}) {
  ...
  return (
    <>
      {hideSeo ? null : (
        <Seo title="Знак Отличия — Красивые автономера Москва и Московская область | Красивые гос номера, оценка автономера, выкуп автономера" description="Купить красивые автономера в Москве и Московской области. Оценить автономер. Выкупить автономер. Купить гос номер. Оценить гос номер" />
      )}
      <div> <div
  aria-hidden
  className="
