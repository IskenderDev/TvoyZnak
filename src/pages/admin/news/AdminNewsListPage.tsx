    ...
    if (items.length === 0) {
      return (
        <EmptyState
          ...
          description="Создайте первую новость, чтобы начать работать с контентом."
          action={
  ...
  return (
    <div className="space-y-8">
      ...
      <ConfirmDialog
        ...
        description="Это действие нельзя отменить. Новость будет удалена без возможности восстановления."
        confirmText="Удалить"
