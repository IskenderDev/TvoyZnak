...
export default function ContactSection() {
  return (
    <section className="text-white pb-10 sm:pb-14">
      <div className="max-w-[1100px] mx-auto px-5 sm:px-6">
        <h2 className="text-center font-bold uppercase leading-tight text-[22px] sm:text-[36px]">
          <span className="text-[#0177FF]">СВЯЖИТЕСЬ С НАМИ</span> УДОБНЫМ СПОСОБОМ — МЫ
          <br /> ЦЕНИМ ВАШЕ ВРЕМЯ И ГОТОВЫ К ДИАЛОГУ
        </h2>

        <p className="mt-4 text-center text-white/80 text-sm sm:text-lg max-w-[820px] mx-auto">
