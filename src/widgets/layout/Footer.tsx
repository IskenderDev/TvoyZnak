    ...
    <footer className="bg-gradient-to-r from-[#001833] via-[#003979] to-[#004899] text-white p-10">
      <Container>
        <div className="grid gap-8 lg:gap-18 lg:grid-cols-[auto_1fr_auto] items-start mx-auto max-w-[1120px]">
          ...
          <div className="flex flex-col items-start lg:items-end gap-3 order-2 lg:order-last">
            <a
              href="tel:+79959202090"
              className="text-xl lg:text-3xl font-semibold text-white hover:text-[#85B6FF] transition-colors"
            >
              +7 (995) 920-20-90
            </a>
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-16 order-3 lg:order-none">
            <div>
