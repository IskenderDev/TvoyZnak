  ...
  return (
    <section aria-labelledby="services-title" className="py-10 lg:py-14">
      <div className="mx-auto max-w-[1100px] px-5 lg:px-10">
        <h2
          id="services-title"
          className="text-center text-[22px] lg:text-[36px] font-bold tracking-[0.08em] text-white uppercase"
        >
          НАШИ УСЛУГИ
        </h2>

        <div className="mt-8 lg:mt-10 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-5 max-w-[900px]">
          {[
            {
            ...
            <Link
              ...
              className="w-full min-h-[60px] inline-flex items-center justify-center text-center
                text-[14px] lg:text-[16px] font-semibold leading-snug bg-[#1C1C1C] text-white
        ...
        <div className="mt-6 text-center">
          <Link
            ...
            className="inline-flex items-center justify-center rounded-full bg-[#0177FF] text-white
              px-6 py-2 text-[14px] lg:text-[16px]
