export default function WhyChooseUs() {
	const cardBase =
		...
		"text-[12px] lg:text-[14px] leading-[1.5] px-4 py-3 shadow-[0_10px_24px_rgba(0,0,0,0.25)] " +
		"max-w-[260px] lg:max-w-[360px]"


	return (
		<section className="relative text-white py-10 lg:py-14" aria-label="Почему выбирают нас">
			<div className="max-w-[1120px] mx-auto px-6 lg:px-10">
				<header className="text-center">
					<h2 className="text-[22px] lg:text-[36px] font-bold tracking-[0.06em] uppercase">
						ПОЧЕМУ ВЫБИРАЮТ НАС
					</h2>
				</header>

				<div className="relative mx-auto mt-6 lg:mt-8">
					<div className="relative mt-4 lg:mt-6 rounded-[26px] px-4 lg:px-8 py-10 lg:py-14 bg-[url('/about-img/circles.svg')] bg-center bg-no-repeat bg-contain">
						<ul className="grid grid-cols-1 gap-y-4 lg:gap-y-6">
							<li
								role="note"
								aria-label="Официальные сделки через МРЭО с внесением данных в ПТС и СТС"
								className={`${cardBase} justify-self-end lg:translate-x-6`}
							>
							...
							<li
								...
								className={`${cardBase} justify-self-start lg:-translate-x-6`}
							>
