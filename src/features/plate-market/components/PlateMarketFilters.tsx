    ...
    <div className={`flex flex-col items-center justify-center gap-4 ${className}`}>
      ...
      <div className="flex w-full flex-wrap items-center gap-3 rounded-4xl bg-white p-4  sm:p-6 md:p-4">
        ...
        <button
          type="button"
          onClick={onReset}
          className="w-full rounded-full border border-black/20 px-4 py-2 text-sm font-[400] text-black/80 transition hover:bg-black/5 lg:ml-auto lg:w-auto flex items-center justify-center gap-2 md:text-lg bg-[#eeeeee] " 
        >
