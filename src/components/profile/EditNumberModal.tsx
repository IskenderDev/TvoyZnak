        ...
        <div className="relative max-h-[90vh] w-full max-w-[1200px] overflow-hidden rounded-[32px] bg-[#fff] text-black shadow-2xl">
          ...
          <div className="max-h-[90vh] overflow-y-auto px-6 pb-8 pt-10 sm:px-10 sm:pb-10 sm:pt-12">
            ...
            <div className="mx-auto w-full max-w-[1200px]">
              <h2 className="text-center text-2xl uppercase sm:text-3xl lg:text-4xl">
                Изменение объявления
              </h2>
              <p className="mt-3 text-center text-sm text-black/70 lg:text-base">
              ...
              <form
                className="mt-6 w-full max-w-[960px] mx-auto space-y-6 lg:mt-8"
