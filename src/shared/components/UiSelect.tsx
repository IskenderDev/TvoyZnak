      ...
      {dropdownWidth === "content" && (
        <span
          ...
          className={[
            ...
            "inline-flex items-center text-sm lg:text-xl justify-center rounded-full border border-white/30 px-3 py-1.5 font-semibold min-h-10",
          ].join(" ")}
        >
          ...
          {options.map((opt, idx) => {
            ...
            return (
              ...
              >
                <span
                  className={[
                    "inline-flex w-full items-center justify-center rounded-full border border-white/30 px-10 py-2 text-sm lg:text-lg font-[400] min-h-10",
